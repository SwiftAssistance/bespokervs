  ...
  home: {
    ...
    testimonials: {
      ...
      google: {
        rating: '5.0',
        reviewCount: 8,
        label: 'Rated 5.0 from 8 Google reviews',
        url: 'https://www.google.com/maps/place/RVS+Bespoke+Storage+Solutions/data=!4m2!3m1!1s0x0:0x8490575cac5f1938',
        badge: 'Verified Google review',
      },
      items: [
        {
          quote: 'Richard has done a lot of work for me in my home. Built wardrobes, a study, a TV unit and other storage. The work is to an incredibly high standard. Also just a good bloke. Would highly recommend.',
          author: 'Simon K',
          project: 'Wardrobes, study & TV unit',
        },
        {
          quote: 'We have worked with Richard several times over the years - most recently he built us a substantial set of fitted wardrobes for our bedroom. As always, workmanship of the highest quality and tremendous attention to detail. Richard is absolutely first rate and a lovely chap with it - cannot recommend him highly enough.',
          author: 'Michael H',
          project: 'Fitted bedroom wardrobes',
        },
        {
          quote: 'I have used Richard to build wardrobes, shelves and storage in two different Windsor houses over 15 years. He is reliable, communicates well and has a really, really high standard to workmanship. Cannot recommend highly enough.',
          author: 'Rob H',
          project: 'Wardrobes, shelving & storage, Windsor',
        },
        {
