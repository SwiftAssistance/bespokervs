          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="max-w-3xl mx-auto">
              <ImageCarousel images={[
                { src: '/images/home_office_1.jpeg', srcSet: imgSrcSet('/images/home_office_1.jpeg', [400, 800, 1200]), alt: 'Custom fitted home office desk with shelving in Berkshire' },
                { src: '/images/home_office_8.jpeg', srcSet: imgSrcSet('/images/home_office_8.jpeg', [400, 800, 1200]), alt: 'Bespoke fitted study room with integrated shelving in Berkshire' },
                { src: '/images/home_office_9.jpeg', srcSet: imgSrcSet('/images/home_office_9.jpeg', [400, 800, 1200]), alt: 'Custom fitted desk with drawer storage in Windsor home office' },
                { src: '/images/home_office_11.jpeg', srcSet: imgSrcSet('/images/home_office_11.jpeg', [400, 800, 1200]), alt: 'Fitted home office with built-in bookcase and filing in Windsor' },
                { src: '/images/home_office_12.jpeg', srcSet: imgSrcSet('/images/home_office_12.jpeg', [400, 800, 1200]), alt: 'Bespoke fitted home study with matching storage units in Berkshire' },
                { src: '/images/home_office_13.jpeg', srcSet: imgSrcSet('/images/home_office_13.jpeg', [400, 800, 1200]), alt: 'Custom fitted corner desk with overhead cabinets in Slough' },
                { src: '/images/home_office_14.jpeg', srcSet: imgSrcSet('/images/home_office_14.jpeg', [400, 800, 1200]), alt: 'Fitted home office with display shelving in Windsor home' },
                { src: '/images/home_office_2.jpeg', srcSet: imgSrcSet('/images/home_office_2.jpeg', [400, 800, 1200]), alt: 'Bespoke fitted study furniture with integrated storage in Windsor home' },
                { src: '/images/home_office_3.jpeg', srcSet: imgSrcSet('/images/home_office_3.jpeg', [400, 800, 1200]), alt: 'Fitted home office with floor to ceiling bookshelves in Windsor' },
                { src: '/images/home_office_4.jpeg', srcSet: imgSrcSet('/images/home_office_4.jpeg', [400, 800, 1200]), alt: 'Bespoke built-in desk and storage in Berkshire home office' },
                { src: '/images/home_office_5.jpeg', srcSet: imgSrcSet('/images/home_office_5.jpeg', [400, 800, 1200]), alt: 'Custom fitted study with painted cabinetry in Ascot home' },
                { src: '/images/home_office_6.jpeg', srcSet: imgSrcSet('/images/home_office_6.jpeg', [400, 800, 1200]), alt: 'Handcrafted fitted home office with cable management in Windsor' },
                { src: '/images/home_office_7.jpeg', srcSet: imgSrcSet('/images/home_office_7.jpeg', [400, 800, 1200]), alt: 'Fitted alcove desk with overhead storage in Maidenhead' },
              ]} />
            </div>
          </div>
        </section>
