            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div className="space-y-6">
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src={imgUrl('/images/kitchen_1.webp', 600)}
                    srcSet={imgSrcSet('/images/kitchen_1.webp', [400, 600, 800])}
                ...
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src={imgUrl('/images/kitchen_2.webp', 600)}
                    srcSet={imgSrcSet('/images/kitchen_2.webp', [400, 600, 800])}
                    sizes="(max-width: 1024px) 100vw, 50vw"
                    width={800}
                    height={600}
                    loading="lazy"
